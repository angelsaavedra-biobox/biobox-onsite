...
Wami.GUI = function(options) {
	...
	function setOptions(options) {
		if (!options.buttonUrl) {
			options.buttonUrl = "/js/buttons.png";
		}
	...
	function stopRecording() {
		...
		/* angel saavedra */
		Nuevo = 0;
		$("#valor").val(myRecordUrl+Nuevo);
		$("#con_audio").val(1);
		options.recordUrl = myRecordUrl+Nuevo;
	...
	function startPlaying() {
		...
		Wami.startPlaying(options.playUrl+'?'+rando, Wami.nameCallback(onPlayStart), Wami
