...
Wami.setup = function(options) {
	...
	function embedWamiSWF(id, initfn) {
		...
		params.wmode = "opaque";
		params.quality = "high";
		params.expressinstall = "/flash/expressInstall.swf";
		...
		//Wami.swfobject.embedSWF(_options.swfUrl, id, 10, 10, version, null, flashVars, params);
		Wami.swfobject.embedSWF(_options.swfUrl, id, 214, 137, version, null, flashVars, params);
		//Wami.swfobject.embedSWF(_options.swfUrl, id, 300, 300, version, null, flashVars, params);
		//Wami.swfobject.addParam("wmode", "opaque");
